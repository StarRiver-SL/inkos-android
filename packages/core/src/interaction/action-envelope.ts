...
export const ActionEnvelopeSchema = z.object({
  ...
  actionSource: ActionSourceSchema.default("free-text"),
  requestedIntent: RequestedIntentSchema.optional(),
...
export function normalizeActionEnvelope(value: unknown): ActionEnvelope {
  return ActionEnvelopeSchema.parse(value);
}
